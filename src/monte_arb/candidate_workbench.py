"""Candidate scanner for the read-only cross-venue research workbench.

Public seam: build_candidate_snapshot() from raw catalogs, books and funding.
No execution client and no orders.
"""
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        prog="python3 -m monte_arb.candidate_workbench",
