"""Day15 experiment B: why is Lighter BRENTOIL spread persistently ~12x xyz:BRENTOIL?
...
from .day14_collector import _parse, _request
from .day15_analysis import MarketEvents, _median, load_session_events
...
def fetch_rest_book(identity: MarketIdentity, timeout: float = 20.0) -> dict[str, Any]:
    ...
    monotonic ns used by day14 collector internals.
    """
