"""Generate a compact lesson asset from a real execution snapshot.

Usage: PYTHONPATH=src python3 -m monte_arb.execution_lesson_data \
        ...
        for size_row in row["per_size"]:
            ...
            for direction in ("buy_left_sell_right", "buy_right_sell_left"):
                ...
                compact[direction] = {
                    ...
                    "executable_spread_bps": d.get("executable_spread_bps"),
                    "slippage_cost_bps": d["slippage_cost_bps"],
                    "fee_cost_bps": d["fee_cost_bps"],
                    "price_pnl_bps": d.get("price_pnl_bps"),
                    "net_price_pnl_bps": d.get("net_price_pnl_bps"),
                    "net_spread_bps": d["net_spread_bps"],
                    "total_cost_bps": d["total_cost_bps"],
                    "fill_pct": d["fill_pct"],
                    "common_exposure_units": d.get("common_exposure_units"),
                    "residual_base_qty": d.get("residual_base_qty"),
                    "round_trip": size_row.get(f"{direction}_round_trip"),
                }
...
def main(argv: Optional[Sequence[str]] = None) -> int:
    ...
    args.out.write_text(
        f"/* Generated by monte_arb.execution_lesson_data — do not edit by hand. */\n"
        f"window.DAY16 = {body};\n",
        encoding="utf-8",
    )
