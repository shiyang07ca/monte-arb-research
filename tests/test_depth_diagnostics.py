...
from monte_arb.market_event_analysis import MarketEvents
from monte_arb.depth_diagnostics import depth_structure, mid_alignment
...
class TestReportRoundtrip(unittest.TestCase):
    def test_build_report_writes_json(self) -> None:
        with tempfile.TemporaryDirectory() as tmp:
            ...
            from monte_arb.depth_diagnostics import build_report
